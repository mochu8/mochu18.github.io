...
![thread_status]({{ "/public/images/2019/01/thread_status.png" | relative_url }} "java thread status" )
...
![sleep]({{ "/public/images/2019/01/sleep.png" | relative_url }} "sleep" ){:width="500px"}
...
![thread monitor]({{ "/public/images/2019/01/thread_monitor.png" | relative_url }} "thread monitor" ){:width="580"}
